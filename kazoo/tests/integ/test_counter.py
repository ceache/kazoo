...
class TestKazooCounters:
    def _makeOne(self, zkclient, **kw):
        path = "/" + uuid.uuid4().hex
        return zkclient.Counter(path, **kw)

    def test_int_counter(self, zkclient):
    ...
    def test_int_curator_counter(self, zkclient):
    ...
    def test_float_counter(self, zkclient):
